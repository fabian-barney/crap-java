...
| Woodstox Core | CLI; runtime dependency of Gradle plugin | Apache-2.0 | `META-INF/LICENSE-woodstox-core` in the shaded CLI |
...
The upstream stax2-api and Woodstox Core 7.2.0 binary JARs do not contain NOTICE
files. Their license resources are therefore preserved under stable unique names.
